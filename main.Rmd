...
ggplot() + 
  geom_polygon(data = ecoData, 
               aes(x = long, y = lat, fill = as.factor(binomFootprint), 
                   group = group),
               col = "white") +
  scale_fill_brewer(palette = "Set2", name = "Net Ecological Footprint", labels = c("Deficit", "Reserve")) +
  xlab("Long") +
  ylab("Lat") +
  theme_minimal()
```
...
ggplot() + 
  geom_polygon(data = ecoData, 
               ...
               col = "white") +
  scale_fill_continuous(low = "thistle2", high = "darkred", guide = "colorbar", na.value = "white", name = "Net Ecological Footprint") +
