...
# Conclusion
While our models weren't very good, the lack of significant relationships between net footprint and most of our predictor variables is still fascinating. For instance, we hypothesized that total food production would be a strong predictor of net ecological footprint since it measures the amount of resources extracted from the environment. However, this variable was significant in neither models. The clear next step would simply be to test new predictors and their relationship to net ecological footprint. We could also remove the random effect of continent from our models as our results suggested its presence was unnecessary. 
